    ...
    return (
        <div className="w-full">
                    ...
                    <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        {isImage && (
                            <img
                                src={previewUrl}
                                alt="Preview"
                                className="h-16 w-16 sm:h-20 sm:w-20 rounded-lg object-cover border border-gray-200 flex-shrink-0"
                            />
                        )}

                        {/* Document Icon - Mobile Optimized */}
                        {isDocument && (
                            <div className="h-16 w-16 sm:h-20 sm:w-20 flex items-center justify-center bg-gray-100 rounded-lg border border-gray-200 flex-shrink-0">
                                <svg
                        ...
                        <button
                            type="button"
                            onClick={handleClear}
                            className="flex-shrink-0 min-h-[44px] min-w-[44px] flex items-center justify-center text-red-600 hover:text-red-800 hover:bg-red-50 rounded-full transition-colors"
                            title="Remove file"
                        >
                            <svg
                                className="h-5 w-5"
            ...
            {uploadFailed && onRetry && (
                <div className="mt-2 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 bg-red-50 border border-red-200 rounded-md p-3">
                    <div className="flex items-center">
                        ...
                        <span className="text-sm text-red-800">Upload failed</span>
                    </div>
                    <button
                        type="button"
                        onClick={(e) => {
                        ...
                        className="w-full sm:w-auto inline-flex items-center justify-center min-h-[44px] px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
                    >
