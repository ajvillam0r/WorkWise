                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    <h1 className="text-3xl font-bold mb-2 flex items-center">
                                        ...
                                        {!isGigWorker ? 'Manage Proposals' : 'My Proposals'}
                                    </h1>
                                    <p className="text-blue-100 text-lg">
                                        {!isGigWorker 
                                            ? 'Review and manage proposals from talented gig workers'
                                    ...
                                    <div className="flex items-center mt-4 space-x-6">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm">{!isGigWorker ? 'Total Proposals' : 'Active Proposals'}: {bids.data.length}</span>
                                        </div>
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-sm">{!isGigWorker ? 'Proposal Management' : 'Proposal Tracker'}</span>
                                        </div>
                                    </div>
                                </div>
