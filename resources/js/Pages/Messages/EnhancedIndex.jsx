...
const ConversationCard = ({ conversation, isActive, onClick }) => {
    ...
    const getContractStatusBadge = (status) => {
        const statusConfig = {
            'pending_employer_signature': { label: 'Pending Employer', color: 'bg-yellow-100 text-yellow-700' },
            'pending_gig_worker_signature': { label: 'Pending Worker', color: 'bg-blue-100 text-blue-700' },
            'fully_signed': { label: 'Active Contract', color: 'bg-green-100 text-green-700' },
    ...
    return (
        <Link
            ...
            className={`block p-4 border-b border-gray-100 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200 ${
                        ...
                        <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                />
                                {searchQuery && (
                                    <button
                            ...
                            {filteredConversations.length === 0 ? (
                                searchQuery ? (
                                    <div className="p-12 text-center">
                                        ...
                                        <button
                                            onClick={() => setSearchQuery('')}
                                            className="mt-4 inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        >
                                            Clear search
                                        </button>
                                    </div>
